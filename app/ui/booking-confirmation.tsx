...
export default function BookingConfirmation() {
    ...
    const fetchBookingDetails = async () => {
      try {
        ...
        if (mockBookingDetails.email) {
          const emailSent = await sendBookingConfirmationEmail(mockBookingDetails, qrCode)
          if (emailSent) {
  ...
  const sendBookingConfirmationEmail = async (bookingDetails: BookingDetails, qrCodeUrl: string) => {
    try {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-gray-800">Explore Ease</span>
            </div>
            <nav className="hidden md:flex space-x-8">
              <a href="/" className="text-gray-600 hover:text-indigo-600 transition-colors">Home</a>
              <a href="/destinations" className="text-gray-600 hover:text-indigo-600 transition-colors">Destinations</a>
      ...
      <footer className="bg-gray-900 text-white mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Explore Ease</h3>
              <p className="text-gray-400">Making your travel dreams a reality. Discover amazing destinations and create unforgettable memories.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>Email: support@exploreease.com</li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Explore Ease. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
