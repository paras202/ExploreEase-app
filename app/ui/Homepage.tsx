    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <section className="bg-gradient-to-r from-purple-500 to-indigo-500 dark:from-purple-700 dark:to-indigo-900 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8">Explore the worlds most exciting destinations with ExploreEase</p>
      ...
      <section className="bg-indigo-100 dark:bg-indigo-900 py-16">
        <div className="container mx-auto px-6">
          <h3 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-8">About ExploreEase</h3>
